...
const {idTopUp} = route.params;
  ...
  useEffect(() => {
    const subscriber = firestore()
      ...
      .onSnapshot(documentSnapshot => {
        ...
        if (DataTopUp) {
          console.log('data: ', DataTopUp);
          setDataTopUp({
            title: DataTopUp.title,
            content: DataTopUp.content,
            category: {
              id: DataTopUp.category.id,
              name: DataTopUp.category.name,
            },
          });
          setOldImage(DataTopUp.image);
          setImage(DataTopUp.image);
          setLoading(false);
        } else {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await firestore().collection('YStore').doc(idTopUp).update({
        title: DataTopUp.title,
      ...
      setLoading(false);
      console.log('Updated!');
      navigation.navigate('DetailBlog', {idTopUp});
    } catch (error) {
      console.log(error);
    }
  };
